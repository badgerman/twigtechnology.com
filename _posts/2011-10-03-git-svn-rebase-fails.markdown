...
working. Some digging showed that it wasn’ using plink to talk to putty anymore,
but using openssh. This despite my having told the git installer that I would
like to use plink.exe (and pageant).

<!-- more -->
What was going on? git wasn’t to blame here - it was svn that was using plink. I
